...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLastRAU:[I
...
.method private isCustomizeFixRoaming(Landroid/telephony/ServiceState;)Z
    .locals 10
    .parameter "s"
    ...
    .line 2607
    .local v4, simRecords:Lcom/android/internal/telephony/gsm/SIMRecords;
    ...
    const-string v9, "fix National roaming, simNum="
    ...
    .end local v3           #simNumeric:Ljava/lang/String;
    :cond_2
    const-string v3, ""
    ...
    .restart local v3       #simNumeric:Ljava/lang/String;
    :catch_0
    move-exception v7
    ...
    const-string v9, "fix Charition Valley roaming, simNum="
    ...
    const-string v8, "It\'s Chariton Valley SIM and network, not regard it as roaming"
    ...
    const-string v9, "fix France roaming, simNum="
    ...
    const-string v9, "fix UK roaming, simNum="
    ...
    const-string v9, "fix Spain roaming, simNum="
    ...
    const-string v9, "fix Yoigo roaming, simNum="
    ...
    const-string v9, "fix Euskaltel roaming, simNum="
    ...
    const-string v9, "fix Austria roaming, simNum="
    ...
    const-string v8, "It\'s Austria Telstra SIM and network, not regard it as roaming"
    ...
    const-string v9, "fix Idea roaming, simNum="
    ...
    const-string v9, "fix Chile  roaming, simNum="
    ...
    const-string v9, "fix  HK roaming, simNum="
    ...
    const-string v9, "fix  France Virgin FULL MVNO roaming, simNum="
    ...
    const-string v9, "fix NRJ FULL MVNO roaming, simNum="
    ...
    const-string v9, "fix Albert Heijn NL roaming, simNum="
    ...
    const-string v9, "fix CMHK roaming, simNum="
    ...
    const-string v9, "fix HK Unicom roaming, simNum="
    ...
    const-string v9, "fix Romania Cosmote roaming, simNum="
    ...
    const-string v8, "It\'s bob SIM and network, not regard it as roaming"
    ...
    const-string v8, "It\'s Telering SIM and network, not regard it as roaming"
...
.method private onInvalidSimInfoReceived(Landroid/os/AsyncResult;)V
    ...
    .line 4138
    .local v3, ivsr_isdm:Z
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "onInvalidSimInfoReceived, ivsr_isdm = "
    ...
    .line 4146
    :cond_1
    const-string v7, "gsm.gcf.testmode"

    invoke-static {v7, v12}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I
    ...
    const-string/jumbo v8, "onInvalidSimInfoReceived testMode:"
    ...
    const-string/jumbo v8, "mEverIVSR"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-boolean v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mEverIVSR:Z
    ...
    const-string v8, "InvalidSimInfo received during test mode: "
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLastRegisteredPLMN:Ljava/lang/String;
    ...
    .line 4160
    const-string v7, "InvalidSimInfo set TRM due to CS invalid"

    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->log(Ljava/lang/String;)V

    .line 4161
    invoke-virtual {p0, v10}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->setEverIVSR(Z)V
    ...
    invoke-virtual {v7, v11, v9}, Lcom/android/internal/telephony/gsm/GSMPhone;->setTRM(ILandroid/os/Message;)V
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLastPSRegisteredPLMN:Ljava/lang/String;
    ...
    .line 4171
    const-string v7, "InvalidSimInfo set TRM due to PS invalid "
...
.method private onPSNetworkStateChangeResult(Landroid/os/AsyncResult;)V
    ...
    .line 2145
    :cond_0
    const-string/jumbo v8, "onPSNetworkStateChangeResult exception"
    ...
    const-string/jumbo v9, "onPSNetworkStateChangeResult state:"
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLastRAU:[I
    ...
    .line 2165
    const-string/jumbo v8, "onPSNetworkStateChangeResult broadcast ACTION_NETWORK_RAU_CHANGED"
    ...
    const-string v8, "android.action.NETWORK_RAU_CHANGED"

    invoke-direct {v4, v8}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2167
    .local v4, intent:Landroid/content/Intent;
    const-string/jumbo v8, "lastRau"

    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLastRAU:[I

    invoke-virtual {v4, v8, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[I)Landroid/content/Intent;

    .line 2168
    const-string/jumbo v8, "rau"
    ...
    .line 2174
    :cond_7
    const-string/jumbo v8, "onPSNetworkStateChangeResult length zero"
...
.method private pollStateDone()V
    ...
    const-string v38, "Iusacell 4G"

    const-string v39, "Iusacell 4G"

    const-string v40, "334050"
    ...
    const-string v38, "Iusacell GSM"

    const-string v39, "Iusacell GSM"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {v0, v5}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->onPSNetworkStateChangeResult(Landroid/os/AsyncResult;)V
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isCustomizeFixRoaming(Landroid/telephony/ServiceState;)Z
...
.method public refreshSpnDisplay()V
    ...
    const-string/jumbo v5, "lookup GSST refreshSpnDisplay(): "
...
.method protected updateSpnDisplay(Z)V
    ...
    .line 3772
    .local v21, simRecords:Lcom/android/internal/telephony/gsm/SIMRecords;
    move-object/from16 v0, p0
    ...
    .line 3783
    .local v23, strNumPlmn:Ljava/lang/String;
    if-eqz v21, :cond_13

    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/SIMRecords;->getServiceProviderName()Ljava/lang/String;
    ...
    .line 3788
    .local v16, sEons:Ljava/lang/String;
    const/16 v17, 0x0
    ...
    .line 3804
    .local v14, realPlmn:Ljava/lang/String;
    if-eqz v21, :cond_15
    ...
    const-string v26, "No matched EONS and No CPHS ONS"
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/telephony/ServiceState;->getOperatorAlphaShort()Ljava/lang/String;
    ...
    const-string/jumbo v26, "updateSpnDisplay mEmergencyOnly="
    ...
    const-string v26, " mRadioState.isOn()="
    ...
    .line 3850
    const-string/jumbo v25, "updateSpnDisplay show mEmergencyOnly"
    ...
    invoke-interface/range {v25 .. v25}, Lcom/mediatek/common/telephony/IServiceStateExt;->getEccPlmnValue()Ljava/lang/String;
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GSMPhone;->isDeviceIdAbnormal()I

    move-result v6

    .line 3874
    .local v6, imeiAbnormal:I
    const/16 v25, 0x1
    ...
    sget-object v26, Lcom/android/internal/telephony/CommandsInterface$RadioState;->RADIO_UNAVAILABLE:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/internal/telephony/uicc/UiccController;->getInstance(I)Lcom/android/internal/telephony/uicc/UiccController;

    move-result-object v25

    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCard()Lcom/android/internal/telephony/UiccCard;

    move-result-object v24

    .line 3929
    .local v24, uiccCard:Lcom/android/internal/telephony/UiccCard;
    move-object/from16 v0, p0
    ...
    .line 3940
    :cond_b
    const-string v25, "OP01"

    const-string/jumbo v26, "ro.operator.optr"
    ...
    const-string/jumbo v26, "origin showSpn:"
    ...
    const-string/jumbo v26, "op01 showSpn:"
    ...
    .line 3957
    const-string v25, "get display rule from perso,the value of persoRule is 0x01, means show SPN only if the SPN exists in sim card and not empty"
    ...
    const-string v25, "android.provider.Telephony.SPN_STRINGS_UPDATED"
    ...
    .line 4060
    const-string/jumbo v25, "showSpn"
    ...
    .line 4062
    const-string/jumbo v25, "showPlmn"
    ...
    const-string/jumbo v26, "plmn_name_sim2"
    ...
    const-string/jumbo v26, "spn_name_sim2"
    ...
    const-string/jumbo v27, "show_plmn_sim2"
    ...
    const-string/jumbo v27, "show_spn_sim2"
    ...
    .line 4082
    const-string/jumbo v25, "updateAllOpertorInfo with spn"
    ...
    .line 3778
    .end local v6           #imeiAbnormal:I
    .end local v8           #mSimOperatorNumeric:Ljava/lang/String;
    .end local v12           #plmn:Ljava/lang/String;
    .end local v14           #realPlmn:Ljava/lang/String;
    .end local v15           #rule:I
    .end local v16           #sEons:Ljava/lang/String;
    .end local v17           #showPlmn:Z
    .end local v18           #showSpn:Z
    .end local v22           #spn:Ljava/lang/String;
    .end local v23           #strNumPlmn:Ljava/lang/String;
    .end local v24           #uiccCard:Lcom/android/internal/telephony/UiccCard;
    :cond_12
    const/4 v15, 0x2
    ...
    .restart local v23       #strNumPlmn:Ljava/lang/String;
    :cond_13
    const-string v22, ""
    ...
    .line 3793
    .restart local v16       #sEons:Ljava/lang/String;
    ...
    const-string v26, "Exception while getEonsIfExist. "
    ...
    .restart local v14       #realPlmn:Ljava/lang/String;
    :cond_15
    const-string v8, ""
    ...
    const-string v26, "Home PLMN, get CPHS ons"
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/gsm/SIMRecords;->getSIMCPHSOns()Ljava/lang/String;
    ...
    .line 3885
    .restart local v6       #imeiAbnormal:I
    :cond_18
    const/16 v25, 0x2
    ...
    invoke-interface {v0, v12, v1}, Lcom/mediatek/common/telephony/IServiceStateExt;->onUpdateSpnDisplay(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 3955
    .restart local v11       #persoRule:I
    .restart local v18       #showSpn:Z
    .restart local v24       #uiccCard:Lcom/android/internal/telephony/UiccCard;
    :cond_1c
    const/16 v18, 0x0
    ...
    .line 3961
    :try_start_2
    const-string v25, "get display rule from perso,the value of persoRule is 0x02 now,means show PLMN only"
    ...
    .line 3965
    const-string v25, "get display rule from perso,the value of persoRule is 0x03 now,means show both PLMN and SPN"
    ...
    .line 3979
    .local v19, simMcc:Ljava/lang/String;
    move-object/from16 v0, v19
    ...
    const-string/jumbo v26, "persoRule(0x04) operatorNumeric: "
    ...
    .line 3987
    .end local v9           #operatorMcc:Ljava/lang/String;
    .end local v10           #operatorNumeric:Ljava/lang/String;
    .end local v19           #simMcc:Ljava/lang/String;
    ...
    const-string v26, "get display rule from perso,the value of persoRule is 0x04 now,means show SPN only if the SPN exists in sim card and not empty  when in national roaming and the roaming state is"
    ...
    .line 3980
    .restart local v9       #operatorMcc:Ljava/lang/String;
    .restart local v10       #operatorNumeric:Ljava/lang/String;
    .restart local v19       #simMcc:Ljava/lang/String;
    .restart local v20       #simNumeric:Ljava/lang/String;
    :cond_23
    const/16 v18, 0x0
    ...
    .line 3994
    const-string v25, "get display rule from perso,the value of persoRule is 0x05 now,means show SPN only if the SPN exists in sim card and not empty  when the roaming state is false"
    ...
    const-string v26, "get display rule from perso,the value of persoRule is 0x06 ,means show SPN only if the SPN exists in sim card and not empty when register in 2G HPLMN, else show both PLMN and SPNmRilRadioTechnology:"
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/telephony/ServiceState;->getRadioTechnology()I
    ...
    const-string/jumbo v26, "plmn_name_sim1"
    ...
    const-string/jumbo v26, "spn_name_sim1"
    ...
    const-string/jumbo v27, "show_plmn_sim1"
    ...
    const-string/jumbo v27, "show_spn_sim1"
    ...
    .line 4086
    :cond_31
    const-string/jumbo v25, "updateAllOpertorInfo with realPlmn"
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->updateAllOpertorInfo(Ljava/lang/String;)I
