...
.method public constructor <init>()V
    ...
    .line 151
    iput-boolean v0, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mNoScreen:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 200
    .local v0, aaccountManager:Landroid/accounts/AccountManager;
    ...
    .line 205
    .local v5, wl:Landroid/view/WindowManager$LayoutParams;
    const/4 v6, 0x0
    ...
    .line 207
    iput-boolean v10, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mNoScreen:Z

    .line 211
    .end local v0           #aaccountManager:Landroid/accounts/AccountManager;
    ...
    .end local v5           #wl:Landroid/view/WindowManager$LayoutParams;
    :cond_3
    return-void
    ...
    .line 182
    .local v3, selectedAccount:Landroid/accounts/Account;
    if-eqz v3, :cond_1
...
.method protected onResume()V
    ...
    iput-object v5, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAccounts:Ljava/util/ArrayList;

    .line 224
    iget v5, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mPendingRequest:I

    if-nez v5, :cond_2

    iget-boolean v5, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mIsCanceled:Z

    if-nez v5, :cond_2

    .line 227
    iget-object v5, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAccounts:Ljava/util/ArrayList;
    ...
    .line 231
    .local v4, wl:Landroid/view/WindowManager$LayoutParams;
    const/4 v5, 0x0
    ...
    .end local v4           #wl:Landroid/view/WindowManager$LayoutParams;
    :goto_0
    return-void

    .line 237
    .restart local v3       #window:Landroid/view/Window;
    .restart local v4       #wl:Landroid/view/WindowManager$LayoutParams;
    :cond_0
    invoke-direct {p0}, Landroid/accounts/ChooseTypeAndAccountActivity;->startChooseAccountTypeActivity()V
    ...
    .end local v4           #wl:Landroid/view/WindowManager$LayoutParams;
    :cond_1
    iget-boolean v5, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAlwaysPromptForAccount:Z
    ...
    invoke-direct {p0, v5, v6}, Landroid/accounts/ChooseTypeAndAccountActivity;->setResultAndFinish(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5}, Landroid/accounts/ChooseTypeAndAccountActivity;->getListOfDisplayableOptions(Ljava/util/ArrayList;)[Ljava/lang/String;
    ...
    iget-boolean v9, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mSelectedAddNewAccount:Z

    invoke-direct {p0, v5, v8, v9}, Landroid/accounts/ChooseTypeAndAccountActivity;->getItemIndexToSelect(Ljava/util/ArrayList;Ljava/lang/String;Z)I
