...
.field private static final BOOT_SYS_PROPERTY:Ljava/lang/String; = "persist.sys.is_first_time_boot"

.field private static final DATA_OFF_NOTIFICATION_ID:I = 0x1869f

.field private static final DBG:Z = true

.field private static final DEFAULT_COUNTRY_CODE:Ljava/lang/String; = "EU"
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Lcom/android/server/ConnectivityService$NetworkFactory;)V
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mSecurityRunnable:Ljava/lang/Runnable;
    ...
    .line 668
    new-instance v41, Landroid/net/wifi/WifiStateTracker;
    ...
    .line 670
    .local v41, wst:Landroid/net/wifi/WifiStateTracker;
    ...
    .line 673
    .local v11, countryStr:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 675
    .local v13, defaultTxPower_2G4b:I
    ...
    const-string v3, "wifi channel is set by DEFAULT_COUNTRY_CODE"
    ...
    .line 682
    :cond_17
    const-string v2, "persist.sys.is_first_time_boot"
    ...
    .line 683
    .local v39, tempString:Ljava/lang/String;
    if-eqz v39, :cond_19
    ...
    const-string v3, "wifi channel set by Country Code only when first boot"
    ...
    invoke-virtual {v0, v10, v13}, Landroid/net/wifi/WifiStateTracker;->writeNvram(Ljava/lang/String;I)Z
    ...
    .end local v11           #countryStr:Ljava/lang/String;
    .end local v13           #defaultTxPower_2G4b:I
    .end local v24           #isFirstBoot:Z
    .end local v39           #tempString:Ljava/lang/String;
    :cond_18
    :goto_10
    move-object/from16 v0, p0
    ...
    .line 703
    .end local v41           #wst:Landroid/net/wifi/WifiStateTracker;
    :catch_3
    move-exception v15
    ...
    .line 683
    .end local v15           #e:Ljava/lang/IllegalArgumentException;
    .restart local v11       #countryStr:Ljava/lang/String;
    .restart local v13       #defaultTxPower_2G4b:I
    .restart local v39       #tempString:Ljava/lang/String;
    .restart local v41       #wst:Landroid/net/wifi/WifiStateTracker;
    :cond_19
    const/16 v24, 0x0
    ...
    .line 692
    .restart local v24       #isFirstBoot:Z
    :cond_1a
    const/4 v2, 0x1
    ...
    .line 702
    .local v40, tracker:Landroid/net/NetworkStateTracker;
    move-object/from16 v0, p0
    ...
    .line 711
    invoke-interface/range {v40 .. v40}, Landroid/net/NetworkStateTracker;->reconnect()Z
    ...
    .end local v9           #config:Landroid/net/NetworkConfig;
    .end local v38           #targetNetworkType:I
    .end local v40           #tracker:Landroid/net/NetworkStateTracker;
    :cond_1c
...
.method static synthetic access$1200(Lcom/android/server/ConnectivityService;Z)V
    ...
    .prologue
    .line 214
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->setMobileDataEnabledAfterSecurity(Z)V
...
.method static synthetic access$4700(Lcom/android/server/ConnectivityService;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 214
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->setMobileDataEnabledGemini_in(I)Z
...
.method private setMobileDataEnabledAfterSecurity(Z)V
    .locals 11
    .parameter "enabled"
...
.method private setMobileDataEnabledGemini_in(I)Z
    .locals 7
    .parameter "slotId"
...
.method public setMobileDataEnabled(Z)V
    ...
    const-string v2, "setMobileDataEnabled , uid: "
    ...
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->mSecurityRunnable:Ljava/lang/Runnable;
    ...
    invoke-static/range {v0 .. v5}, Landroid/os/CTAManager;->directAsyncCheckIncludeSystem(ILjava/lang/String;Ljava/lang/Runnable;Ljava/lang/Runnable;Ljava/lang/CharSequence;I)V
...
.method public setMobileDataEnabledGemini(I)Z
    ...
    .line 4706
    .local v6, no_sim_id:J
    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "setMobileDataEnabledGemini oldSimID = "
    ...
    invoke-direct {v2, p0, v12}, Lcom/android/server/ConnectivityService$5;-><init>(Lcom/android/server/ConnectivityService;I)V
    ...
    .line 4723
    .end local v0           #callthisUid:I
    .end local v12           #slot_id:I
    :goto_0
    return v1
