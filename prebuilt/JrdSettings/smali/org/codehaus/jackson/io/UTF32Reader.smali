...
.method private loadMore(I)Z
    ...
    iget v5, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I
    ...
    .line 171
    iget v4, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I
    ...
    .line 173
    iget-object v4, p0, Lorg/codehaus/jackson/io/BaseReader;->_buffer:[B

    iget-object v5, p0, Lorg/codehaus/jackson/io/BaseReader;->_buffer:[B

    iget v6, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I
    ...
    .line 175
    :cond_0
    iput v2, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I

    .line 177
    .end local v1           #i:I
    :cond_1
    iput p1, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I

    .line 199
    :goto_1
    iget v2, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I

    if-ge v2, v8, :cond_7

    .line 200
    iget-object v2, p0, Lorg/codehaus/jackson/io/BaseReader;->_in:Ljava/io/InputStream;

    iget-object v4, p0, Lorg/codehaus/jackson/io/BaseReader;->_buffer:[B

    iget v5, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I

    iget-object v6, p0, Lorg/codehaus/jackson/io/BaseReader;->_buffer:[B

    array-length v6, v6

    iget v7, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I
    ...
    .line 207
    :cond_2
    invoke-virtual {p0}, Lorg/codehaus/jackson/io/BaseReader;->reportStrangeStream()V
    ...
    iput v2, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I
    ...
    .line 183
    iget-object v4, p0, Lorg/codehaus/jackson/io/BaseReader;->_in:Ljava/io/InputStream;
    ...
    .line 193
    :cond_6
    iput v0, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I
...
.method private reportInvalid(IILjava/lang/String;)V
    ...
    iget v3, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I
...
.method public read([CII)I
    ...
    .line 65
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lorg/codehaus/jackson/io/BaseReader;->reportBounds([CII)V
    ...
    .local v0, ch:I
    :goto_2
    iget v5, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I

    add-int/lit8 v5, v5, 0x4

    iput v5, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I
    ...
    .line 80
    :cond_7
    iget v6, p0, Lorg/codehaus/jackson/io/BaseReader;->_length:I

    iget v7, p0, Lorg/codehaus/jackson/io/BaseReader;->_ptr:I
