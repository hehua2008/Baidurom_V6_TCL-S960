.class public final Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;
...
.method public constructor <init>()V
    ...
    .line 44
    iput-object v0, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    .line 45
    iput-object v0, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
...
.method private checkUserChoice()Z
    ...
    iget v7, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    :cond_0
    iget-object v7, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/android/jrdsettings/bluetooth/LocalBluetoothManager;->getInstance(Landroid/content/Context;)Lcom/android/jrdsettings/bluetooth/LocalBluetoothManager;
    ...
    iget-object v7, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v7}, Lcom/android/jrdsettings/bluetooth/CachedBluetoothDeviceManager;->findDevice(Landroid/bluetooth/BluetoothDevice;)Lcom/android/jrdsettings/bluetooth/CachedBluetoothDevice;
    ...
    iget-object v9, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v7, v8, v9}, Lcom/android/jrdsettings/bluetooth/CachedBluetoothDeviceManager;->addDevice(Lcom/android/jrdsettings/bluetooth/LocalBluetoothAdapter;Lcom/android/jrdsettings/bluetooth/LocalBluetoothProfileManager;Landroid/bluetooth/BluetoothDevice;)Lcom/android/jrdsettings/bluetooth/CachedBluetoothDevice;

    move-result-object v1

    .line 146
    :cond_1
    invoke-virtual {v1}, Lcom/android/jrdsettings/bluetooth/CachedBluetoothDevice;->getPhonebookPermissionChoice()I
    ...
    invoke-direct {p0, v3, v10, v7, v10}, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->sendIntentToReceiver(Ljava/lang/String;ZLjava/lang/String;Z)V
    ...
    invoke-direct {p0, v3, v11, v7, v11}, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->sendIntentToReceiver(Ljava/lang/String;ZLjava/lang/String;Z)V
...
.method private sendIntentToReceiver(Ljava/lang/String;ZLjava/lang/String;Z)V
    ...
    iget-object v1, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    .line 183
    iget-object v1, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 49
    iput-object p1, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
    ...
    iput-object v9, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iput v9, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iput-object v9, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iput-object v9, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    const-class v9, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionActivity;
    ...
    iget v10, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iget-object v10, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object v10, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;

    invoke-virtual {v1, v9, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 74
    invoke-direct {p0}, Lcom/android/jrdsettings/bluetooth/BluetoothPermissionRequest;->checkUserChoice()Z
    ...
    invoke-static {p1, v3}, Lcom/android/jrdsettings/bluetooth/LocalBluetoothPreferences;->shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
