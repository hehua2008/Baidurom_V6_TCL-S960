.class public Lcom/android/jrdsettings/accounts/ManageAccountsSettings;
...
.method private addAuthenticatorSettings()V
    ...
    .prologue
    .line 350
    iget-object v1, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;

    invoke-virtual {p0}, Landroid/preference/PreferenceFragment;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v2

    invoke-virtual {p0, v1, v2}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->addPreferencesForType(Ljava/lang/String;Landroid/preference/PreferenceScreen;)Landroid/preference/PreferenceScreen;
    ...
    .line 352
    invoke-direct {p0, v0}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->updatePreferenceIntents(Landroid/preference/PreferenceScreen;)V
...
.method private requestOrCancelSyncForAccounts(Z)V
    ...
    instance-of v8, v5, Lcom/android/jrdsettings/AccountPreference;

    if-eqz v8, :cond_2

    .line 199
    check-cast v5, Lcom/android/jrdsettings/AccountPreference;

    .end local v5           #pref:Landroid/preference/Preference;
    invoke-virtual {v5}, Lcom/android/jrdsettings/AccountPreference;->getAccount()Landroid/accounts/Account;
    ...
    iget-object v9, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;
...
.method private startAccountSettings(Lcom/android/jrdsettings/AccountPreference;)V
    .locals 7
    .parameter "acctPref"
    ...
    invoke-virtual {p1}, Lcom/android/jrdsettings/AccountPreference;->getAccount()Landroid/accounts/Account;
...
.method private updatePreferenceIntents(Landroid/preference/PreferenceScreen;)V
    ...
    iget-object v5, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mFirstAccount:Landroid/accounts/Account;
...
.method public onAccountsUpdated([Landroid/accounts/Account;)V
    ...
    iput-object v1, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mFirstAccount:Landroid/accounts/Account;
    ...
    iget-object v5, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->getAuthoritiesForAccountType(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAuthorities:[Ljava/lang/String;
    ...
    .line 320
    iget-object v6, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAuthorities:[Ljava/lang/String;
    ...
    new-instance v0, Lcom/android/jrdsettings/AccountPreference;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/jrdsettings/AccountPreference;-><init>(Landroid/content/Context;Landroid/accounts/Account;Landroid/graphics/drawable/Drawable;Ljava/util/ArrayList;Z)V

    .line 332
    .local v0, preference:Lcom/android/jrdsettings/AccountPreference;
    invoke-virtual {p0}, Landroid/preference/PreferenceFragment;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 333
    iget-object v1, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mFirstAccount:Landroid/accounts/Account;

    if-nez v1, :cond_1

    .line 334
    iput-object v2, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mFirstAccount:Landroid/accounts/Account;

    goto :goto_2

    .line 320
    .end local v0           #preference:Lcom/android/jrdsettings/AccountPreference;
    ...
    .line 339
    invoke-direct {p0}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->addAuthenticatorSettings()V

    .line 346
    :goto_4
    invoke-virtual {p0}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->onSyncStateUpdated()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mErrorInfoView:Landroid/widget/TextView;

    .line 119
    iget-object v3, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mErrorInfoView:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAuthorities:[Ljava/lang/String;
    ...
    .line 127
    :cond_0
    invoke-virtual {p0}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->updateAuthDescriptions()V
...
.method protected onAuthDescriptionsUpdated()V
    ...
    instance-of v3, v2, Lcom/android/jrdsettings/AccountPreference;
    ...
    .line 380
    check-cast v0, Lcom/android/jrdsettings/AccountPreference;

    .line 381
    .local v0, accPref:Lcom/android/jrdsettings/AccountPreference;
    invoke-virtual {v0}, Lcom/android/jrdsettings/AccountPreference;->getAccount()Landroid/accounts/Account;

    move-result-object v3

    iget-object v3, v3, Landroid/accounts/Account;->type:Ljava/lang/String;

    invoke-virtual {p0, v3}, Lcom/android/jrdsettings/accounts/AccountPreferenceBase;->getLabelForType(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    .line 377
    .end local v0           #accPref:Lcom/android/jrdsettings/AccountPreference;
    :cond_0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mAccountType:Ljava/lang/String;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 181
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->requestOrCancelSyncForAccounts(Z)V
    ...
    invoke-direct {p0, v1}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->requestOrCancelSyncForAccounts(Z)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .prologue
    .line 141
    instance-of v0, p2, Lcom/android/jrdsettings/AccountPreference;

    if-eqz v0, :cond_0

    .line 142
    check-cast p2, Lcom/android/jrdsettings/AccountPreference;

    .end local p2
    invoke-direct {p0, p2}, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->startAccountSettings(Lcom/android/jrdsettings/AccountPreference;)V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    iget-object v3, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mFirstAccount:Landroid/accounts/Account;
    ...
    iget-object v4, p0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mFirstAccount:Landroid/accounts/Account;
...
.method protected onSyncStateUpdated()V
    ...
    instance-of v0, v0, Lcom/android/jrdsettings/AccountPreference;
    ...
    .line 242
    check-cast v3, Lcom/android/jrdsettings/AccountPreference;

    .line 243
    .local v3, accountPref:Lcom/android/jrdsettings/AccountPreference;
    invoke-virtual {v3}, Lcom/android/jrdsettings/AccountPreference;->getAccount()Landroid/accounts/Account;
    ...
    invoke-virtual {v3}, Lcom/android/jrdsettings/AccountPreference;->getAuthorities()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v0, v1}, Lcom/android/jrdsettings/AccountPreference;->setSyncStatus(IZ)V
    ...
    invoke-virtual {v0, v11}, Lcom/android/jrdsettings/accounts/AccountPreferenceBase;->formatSyncDate(Ljava/util/Date;)Ljava/lang/String;
    ...
    .line 302
    .end local v2           #account:Landroid/accounts/Account;
    .end local v3           #accountPref:Lcom/android/jrdsettings/AccountPreference;
    ...
    iget-object v0, v0, Lcom/android/jrdsettings/accounts/ManageAccountsSettings;->mErrorInfoView:Landroid/widget/TextView;
