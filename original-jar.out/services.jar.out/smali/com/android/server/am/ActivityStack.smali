...
.method final ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    iget-object v5, v1, Landroid/content/res/Configuration;->fontStylePath:Ljava/lang/String;

    if-eqz v5, :cond_12

    iget-object v5, v1, Landroid/content/res/Configuration;->fontStylePath:Ljava/lang/String;

    iget-object v6, v2, Landroid/content/res/Configuration;->fontStylePath:Ljava/lang/String;
    ...
    :cond_12
    iget-object v5, v1, Landroid/content/res/Configuration;->fontStylePackageName:Ljava/lang/String;

    if-eqz v5, :cond_20

    iget-object v5, v1, Landroid/content/res/Configuration;->fontStylePackageName:Ljava/lang/String;

    iget-object v6, v2, Landroid/content/res/Configuration;->fontStylePackageName:Ljava/lang/String;
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/android/server/am/ActivityStack;->resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Z)Z
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Z)Z
    .locals 25
    .parameter "prev"
    .parameter "options"
    ...
    const-string v3, "com.android.jrdcamera.CameraLauncher"
    ...
    const-string v3, "com.android.jrdcamera.Camera"
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    const-string v4, "call phone"

    const-string v5, ""

    const/4 v6, 0x1

    invoke-static {v2, v4, v5, v6}, Landroid/os/CTAManager;->directCheck(ILjava/lang/String;Ljava/lang/CharSequence;I)Z
    ...
    .line 3571
    const-string v2, "xueming.li"

    const-string v4, "ActivityStack: not allowed"
