...
# instance fields
.field private mAutoStartManager:Landroid/app/IAutoStartManager;
...
.method final processNextBroadcast(Z)V
    ...
    iget-object v3, v0, Lcom/android/server/am/BroadcastQueue;->mAutoStartManager:Landroid/app/IAutoStartManager;
    ...
    invoke-static/range {v16 .. v16}, Landroid/app/IAutoStartManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/IAutoStartManager;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/am/BroadcastQueue;->mAutoStartManager:Landroid/app/IAutoStartManager;
    ...
    invoke-interface {v3, v0}, Landroid/app/IAutoStartManager;->getAutoStartState(Ljava/lang/String;)I
    :try_end_10
    ...
    const-string v3, "android.appwidget.action"
    ...
    const-string v6, "start by broadcast is forbidden : "
    ...
    .end local v15           #autoStartState:I
    ...
    .restart local v4       #targetProcess:Ljava/lang/String;
    .restart local v15       #autoStartState:I
