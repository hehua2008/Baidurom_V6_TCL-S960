...
.field private static final SHOW_TOAST:Ljava/lang/String; = "Systemui.show.toast"

.field private static final STATUSBAR_DB_VERSION:I = 0x1

.field private static final STATUSBAR_TAG_BODY:Ljava/lang/String; = "statusbar-policy"
...
.field private mInterceptPackages:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.field private mInterceptStatusBarFile:Landroid/util/AtomicFile;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    iput-object v8, p0, Lcom/android/server/NotificationManagerService;->turnOffIntent:Landroid/content/Intent;
    ...
    iput-object v8, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;
    ...
    iput-object v8, p0, Lcom/android/server/NotificationManagerService;->am:Landroid/app/AlarmManager;

    .line 883
    iget-object v8, p0, Lcom/android/server/NotificationManagerService;->turnOffIntent:Landroid/content/Intent;

    const-string v9, "com.android.server.NotificationService.turnoffLight"
    ...
    iput-object v8, p0, Lcom/android/server/NotificationManagerService;->contentIntent:Landroid/app/PendingIntent;

    .line 887
    invoke-direct {p0}, Lcom/android/server/NotificationManagerService;->loadBlockDb()V

    .line 890
    invoke-direct {p0}, Lcom/android/server/NotificationManagerService;->loadInterceptIconDb()V
    ...
    .line 949
    const-string v8, "Systemui.show.toast"
...
.method private areStatusBarInterceptedForPackageInt(Ljava/lang/String;)Z
    .locals 4
    .parameter "pkg"

    .prologue
    .line 309
    iget-object v1, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;
    ...
    const-string v3, "statusbar intercept are "
...
.method private cancelNotification(Ljava/lang/String;Ljava/lang/String;IIIZI)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/server/NotificationManagerService;->indexOfNotificationLocked(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    :cond_1
    :try_start_1
    const-string v8, "sys.supermode.key"
    ...
    .line 1704
    .local v1, cmpn:Landroid/content/ComponentName;
    if-eqz v1, :cond_2
    ...
    .line 1707
    const-string v8, "com.android.mms.ui.WPMessageActivity"
    ...
    .line 1717
    .end local v1           #cmpn:Landroid/content/ComponentName;
    .end local v3           #isWapPush:Z
    .end local v4           #mClass:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v0}, Lcom/android/server/NotificationManagerService;->cancelNotificationLocked(Lcom/android/server/NotificationManagerService$NotificationRecord;Z)V
...
.method private loadInterceptIconDb()V
    .locals 12
    ...
    .line 220
    iget-object v8, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;

    monitor-enter v8

    .line 221
    :try_start_0
    iget-object v7, p0, Lcom/android/server/NotificationManagerService;->mInterceptStatusBarFile:Landroid/util/AtomicFile;
    ...
    const-string v10, "statusbar_policy.xml"

    invoke-direct {v9, v0, v10}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {v7, v9}, Landroid/util/AtomicFile;-><init>(Ljava/io/File;)V

    iput-object v7, p0, Lcom/android/server/NotificationManagerService;->mInterceptStatusBarFile:Landroid/util/AtomicFile;

    .line 225
    iget-object v7, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;
    ...
    .line 239
    const-string v7, "statusbar-policy"
    ...
    const-string v9, "Unable to read statusbar interception database"
    ...
    const-string v9, "Unable to parse statusbar interception database"
...
.method private updateStatusBarIconIntercepted(Ljava/lang/String;Z)V
    .locals 3
    .parameter "pkg"
    .parameter "enabled"
    ...
    invoke-virtual {v2, p1, p2}, Lcom/android/server/StatusBarManagerService;->updateStatusBarIconIntercepted(Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private writeInterceptIconDb()V
    .locals 9

    .prologue
    .line 269
    iget-object v6, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;
    ...
    .local v3, outfile:Ljava/io/FileOutputStream;
    :try_start_0
    iget-object v5, p0, Lcom/android/server/NotificationManagerService;->mInterceptStatusBarFile:Landroid/util/AtomicFile;
    ...
    .line 283
    iget-object v5, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;
...
.method public areStatusBarInterceptedForPackage(Ljava/lang/String;)Z
    .locals 1
    .parameter "pkg"
    ...
    .line 304
    invoke-direct {p0, p1}, Lcom/android/server/NotificationManagerService;->areStatusBarInterceptedForPackageInt(Ljava/lang/String;)Z
...
.method public enqueueNotificationInternal(Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[II)V
    ...
    :try_start_4
    invoke-static/range {v41 .. v42}, Landroid/os/Binder;->restoreCallingIdentity(J)V
    ...
    const-string v8, "statusbar_icon_intercepted"
    ...
    .line 1382
    .local v32, intercept:Z
    :goto_5
    if-eqz v32, :cond_f

    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;

    iget-object v8, v6, Lcom/android/internal/statusbar/StatusBarNotification;->pkg:Ljava/lang/String;
    ...
    iput v7, v6, Lcom/android/internal/statusbar/StatusBarNotification;->intercepted:I
    ...
    iget-object v9, v6, Lcom/android/internal/statusbar/StatusBarNotification;->pkg:Ljava/lang/String;

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, "  be intercepted "
    ...
    invoke-interface/range {v37 .. v37}, Lcom/android/internal/telephony/ITelephony;->isOffhook()Z
    :try_end_7
    ...
    .line 1449
    :try_start_8
    new-instance v43, Landroid/media/ToneGenerator;
    ...
    .line 1450
    .local v43, toneGenerator:Landroid/media/ToneGenerator;
    if-eqz v43, :cond_15
    ...
    .line 1452
    invoke-virtual/range {v43 .. v43}, Landroid/media/ToneGenerator;->release()V

    .line 1459
    .end local v33           #isOffhook:Z
    .end local v43           #toneGenerator:Landroid/media/ToneGenerator;
    :cond_15
    move-object/from16 v0, p0
    ...
    .line 1509
    .local v38, player:Landroid/media/IRingtonePlayer;
    if-eqz v38, :cond_18
    ...
    .end local v29           #identity:J
    .end local v35           #looping:Z
    .end local v38           #player:Landroid/media/IRingtonePlayer;
    :cond_19
    :goto_d
    move-object/from16 v0, p6
    ...
    const-string v9, "Couldn\'t connect to phone serveice. "
...
.method public setStatusBarInterceptedForAll(Z)V
    .locals 8
    .parameter "intercept"
    ...
    .line 354
    .local v4, tempSet:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    iget-object v6, p0, Lcom/android/server/NotificationManagerService;->mNotificationList:Ljava/util/ArrayList;
    ...
    iget-object v7, v2, Lcom/android/server/NotificationManagerService$NotificationRecord;->pkg:Ljava/lang/String;
    ...
    const-string v7, "has a status bar icon , update it to "
    ...
    invoke-direct {p0, v5, p1}, Lcom/android/server/NotificationManagerService;->updateStatusBarIconIntercepted(Ljava/lang/String;Z)V
...
.method public setStatusBarInterceptedForPackage(Ljava/lang/String;Z)V
    .locals 6
    .parameter "pkg"
    .parameter "enabled"
    ...
    const-string v5, "intercept statusbar for "
    ...
    .line 322
    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->mInterceptPackages:Ljava/util/HashSet;
    ...
    .line 331
    invoke-direct {p0, p1, p2}, Lcom/android/server/NotificationManagerService;->updateStatusBarIconIntercepted(Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 336
    invoke-direct {p0}, Lcom/android/server/NotificationManagerService;->writeInterceptIconDb()V
