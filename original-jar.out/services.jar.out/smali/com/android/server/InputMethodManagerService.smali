...
.field private static final DEF_LOCALE_SUBTYPE:Ljava/lang/String; = "defSubtype"
...
.method private static getImplicitlyApplicableSubtypesLocked(Landroid/content/res/Resources;Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 3101
    invoke-static/range {p1 .. p1}, Lcom/android/server/InputMethodManagerService;->getSubtypes(Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/ArrayList;
    ...
    .line 3103
    .local v18, systemLocale:Ljava/lang/String;
    ...
    .line 3106
    .local v6, applicableModeAndSubtypesMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Landroid/view/inputmethod/InputMethodSubtype;>;"
    ...
    const-string v19, "ro.product.locale.language"
    ...
    .line 3154
    .local v7, applicableSubtype:Landroid/view/inputmethod/InputMethodSubtype;
    const-string v19, "ro.product.locale.language"
    ...
    .line 3126
    .end local v7           #applicableSubtype:Landroid/view/inputmethod/InputMethodSubtype;
    :cond_6
    :goto_4
    add-int/lit8 v10, v10, 0x1
    ...
    .line 3165
    .restart local v7       #applicableSubtype:Landroid/view/inputmethod/InputMethodSubtype;
    .restart local v9       #defLocaleInput:Z
    :cond_8
    if-eqz v7, :cond_9
    ...
    .line 3176
    .local v12, keyboardSubtype:Landroid/view/inputmethod/InputMethodSubtype;
    new-instance v8, Ljava/util/ArrayList;
    ...
    const-string v19, "AsciiCapable"

    move-object/from16 v0, v19

    invoke-virtual {v12, v0}, Landroid/view/inputmethod/InputMethodSubtype;->containsExtraValueKey(Ljava/lang/String;)Z
    ...
    const-string v19, "EnabledWhenDefaultIsNotAsciiCapable"
    ...
    .line 3191
    .local v13, lastResortKeyboardSubtype:Landroid/view/inputmethod/InputMethodSubtype;
    if-eqz v13, :cond_0
