...
.field private mValidCustDunApn:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/IConnectivityManager;Landroid/os/Looper;)V
    ...
    .line 183
    iput-boolean v5, p0, Lcom/android/server/connectivity/Tethering;->mValidCustDunApn:Z
...
.method static synthetic access$5900()Ljava/lang/Integer;
    .locals 1
...
.method static synthetic access$6100(Lcom/android/server/connectivity/Tethering;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 111
    iget-boolean v0, p0, Lcom/android/server/connectivity/Tethering;->mValidCustDunApn:Z

    return v0
.end method

.method static synthetic access$6102(Lcom/android/server/connectivity/Tethering;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 111
    iput-boolean p1, p0, Lcom/android/server/connectivity/Tethering;->mValidCustDunApn:Z

    return p1
.end method

.method static synthetic access$6300()Ljava/lang/Integer;
    .locals 1
...
.method public isValidTetheringDunApn()Z
    .locals 24
    ...
    iget-object v5, v0, Lcom/android/server/connectivity/Tethering;->mContext:Landroid/content/Context;
    ...
    .line 1150
    .local v18, simPLMN:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v22, "get simId from GPRS_CONNECTION_SIM_SETTING, simId = "
    ...
    const-string v22, " convert --> slotId = "
    ...
    .line 1156
    const-string v20, "gsm.sim.operator.numeric.2"
    ...
    .line 1165
    .local v3, apnMatchPlmn:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/ApnSetting;>;"
    sget v13, Landroid/provider/Settings$Global;->maxDunApnNumber:I

    .line 1168
    .local v13, maxDunApn:I
    const/4 v11, 0x1
    ...
    const-string v21, "tether_dun_apn_custom"
    ...
    .line 1170
    .local v6, customApn:Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/ApnSetting;->fromString(Ljava/lang/String;)Lcom/android/internal/telephony/ApnSetting;

    move-result-object v8

    .line 1172
    .local v8, dunApnSetting:Lcom/android/internal/telephony/ApnSetting;
    if-eqz v8, :cond_0

    .line 1173
    iget-object v10, v8, Lcom/android/internal/telephony/ApnSetting;->numeric:Ljava/lang/String;

    .line 1174
    .local v10, dun_plmn:Ljava/lang/String;
    ...
    const-string v22, "DB dun apn plmn match ="
    ...
    const-string v22, "add DB apn into DUN list, apnItem = "
    ...
    .line 1168
    .end local v10           #dun_plmn:Ljava/lang/String;
    ...
    .line 1158
    .end local v3           #apnMatchPlmn:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/ApnSetting;>;"
    .end local v4           #apnString:Ljava/lang/String;
    .end local v6           #customApn:Ljava/lang/String;
    .end local v8           #dunApnSetting:Lcom/android/internal/telephony/ApnSetting;
    .end local v11           #i:I
    .end local v13           #maxDunApn:I
    :cond_1
    ...
    .line 1184
    .restart local v3       #apnMatchPlmn:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/ApnSetting;>;"
    .restart local v11       #i:I
    .restart local v13       #maxDunApn:I
    :cond_2
    :try_start_1
    ...
    .line 1198
    .local v7, dunApnCust:Ljava/lang/String;
    ...
    .line 1200
    .local v9, dunApnSettingCust:Lcom/android/internal/telephony/ApnSetting;
    if-eqz v9, :cond_4

    .line 1202
    iget-object v10, v9, Lcom/android/internal/telephony/ApnSetting;->numeric:Ljava/lang/String;

    .line 1203
    .restart local v10       #dun_plmn:Ljava/lang/String;
    move-object/from16 v0, v18
    ...
    const-string v22, "custom dun apn plmn match ="
    ...
    const-string v22, "add custom apn into DUN list, apnItem = "
    ...
    .line 1212
    .end local v7           #dunApnCust:Ljava/lang/String;
    .end local v9           #dunApnSettingCust:Lcom/android/internal/telephony/ApnSetting;
    :cond_5
    invoke-virtual {v3}, Ljava/util/ArrayList;->size()I
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
