...
.method private processSelectItem(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 797
    .local p2, ctlvs:Ljava/util/List;,"Ljava/util/List<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    const-string v17, "process SelectItem"
    ...
    .line 799
    new-instance v11, Lcom/android/internal/telephony/cat/Menu;

    invoke-direct {v11}, Lcom/android/internal/telephony/cat/Menu;-><init>()V

    .line 800
    .local v11, menu:Lcom/android/internal/telephony/cat/Menu;
    const/16 v16, 0x0

    .line 801
    .local v16, titleIconId:Lcom/android/internal/telephony/cat/IconId;
    const/4 v8, 0x0

    .line 802
    .local v8, itemsIconId:Lcom/android/internal/telephony/cat/ItemsIconId;
    invoke-interface/range {p2 .. p2}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    sget-object v17, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->ALPHA_ID:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->searchForTag(Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Ljava/util/List;)Lcom/android/internal/telephony/cat/ComprehensionTlv;
    ...
    iput-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->title:Ljava/lang/String;
    :try_end_0
    .catch Lcom/android/internal/telephony/cat/ResultException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v18, "add AlphaId: "

    invoke-virtual/range {v17 .. v18}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v17

    iget-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->title:Ljava/lang/String;
    ...
    :cond_0
    :goto_1
    sget-object v17, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->ITEM:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;

    move-object/from16 v0, p0

    move-object/from16 v1, v17

    invoke-direct {v0, v1, v9}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->searchForNextTag(Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Ljava/util/Iterator;)Lcom/android/internal/telephony/cat/ComprehensionTlv;
    ...
    .line 819
    .local v7, item:Lcom/android/internal/telephony/cat/Item;
    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string v18, "add menu item: "
    ...
    .line 820
    iget-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->items:Ljava/util/List;
    ...
    .line 809
    .end local v7           #item:Lcom/android/internal/telephony/cat/Item;
    :catch_0
    move-exception v6
    ...
    const-string v18, "retrieveAlphaId ResultException: "
    ...
    .restart local v7       #item:Lcom/android/internal/telephony/cat/Item;
    :cond_1
    invoke-virtual {v7}, Lcom/android/internal/telephony/cat/Item;->toString()Ljava/lang/String;
    ...
    .line 829
    new-instance v17, Lcom/android/internal/telephony/cat/ResultException;

    sget-object v18, Lcom/android/internal/telephony/cat/ResultCode;->REQUIRED_VALUES_MISSING:Lcom/android/internal/telephony/cat/ResultCode;

    invoke-direct/range {v17 .. v18}, Lcom/android/internal/telephony/cat/ResultException;-><init>(Lcom/android/internal/telephony/cat/ResultCode;)V

    throw v17

    .line 834
    :cond_3
    sget-object v17, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->NEXT_ACTION_INDICATOR:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    .line 837
    :try_start_1
    invoke-static {v5}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveNextActionIndicator(Lcom/android/internal/telephony/cat/ComprehensionTlv;)[B

    move-result-object v17

    move-object/from16 v0, v17

    iput-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->nextActionIndicator:[B
    :try_end_1
    .catch Lcom/android/internal/telephony/cat/ResultException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    :goto_3
    :try_start_2
    iget-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->nextActionIndicator:[B
    ...
    .line 838
    .end local v4           #NAICopy:[B
    .end local v10           #j:I
    .end local v15           #showLength:I
    :catch_1
    move-exception v6

    .line 839
    .restart local v6       #e:Lcom/android/internal/telephony/cat/ResultException;
    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string v18, "retrieveNextActionIndicator ResultException: "
    ...
    .line 853
    .end local v6           #e:Lcom/android/internal/telephony/cat/ResultException;
    .restart local v4       #NAICopy:[B
    .restart local v10       #j:I
    .restart local v15       #showLength:I
    :cond_4
    :try_start_3
    iput-object v4, v11, Lcom/android/internal/telephony/cat/Menu;->nextActionIndicator:[B
    :try_end_3
    ...
    :cond_5
    :goto_5
    sget-object v17, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->ITEM_ID:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    iput v0, v11, Lcom/android/internal/telephony/cat/Menu;->defaultItem:I
    :try_end_4
    ...
    const-string v18, "default item: "

    invoke-virtual/range {v17 .. v18}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v17

    iget v0, v11, Lcom/android/internal/telephony/cat/Menu;->defaultItem:I
    ...
    .line 881
    :cond_6
    sget-object v17, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->ICON_ID:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    iput v0, v1, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mIconLoadState:I
    ...
    :try_end_5
    .catch Lcom/android/internal/telephony/cat/ResultException; {:try_start_5 .. :try_end_5} :catch_4
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cat/IconId;->selfExplanatory:Z

    move/from16 v17, v0

    move/from16 v0, v17

    iput-boolean v0, v11, Lcom/android/internal/telephony/cat/Menu;->titleIconSelfExplanatory:Z
    :try_end_6
    ...
    :cond_7
    :goto_8
    sget-object v17, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->ITEM_ICON_ID_LIST:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    :try_end_7
    .catch Lcom/android/internal/telephony/cat/ResultException; {:try_start_7 .. :try_end_7} :catch_6
    ...
    :goto_9
    :try_start_8
    iget-boolean v0, v8, Lcom/android/internal/telephony/cat/ItemsIconId;->selfExplanatory:Z

    move/from16 v17, v0

    move/from16 v0, v17

    iput-boolean v0, v11, Lcom/android/internal/telephony/cat/Menu;->itemsIconSelfExplanatory:Z
    :try_end_8
    ...
    .line 912
    .local v13, presentTypeSpecified:Z
    :goto_b
    if-eqz v13, :cond_9
    ...
    .line 914
    sget-object v17, Lcom/android/internal/telephony/cat/PresentationType;->DATA_VALUES:Lcom/android/internal/telephony/cat/PresentationType;

    move-object/from16 v0, v17

    iput-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->presentationType:Lcom/android/internal/telephony/cat/PresentationType;
    ...
    iput-boolean v0, v11, Lcom/android/internal/telephony/cat/Menu;->softKeyPreferred:Z
    ...
    iput-boolean v0, v11, Lcom/android/internal/telephony/cat/Menu;->helpAvailable:Z

    .line 922
    new-instance v18, Lcom/android/internal/telephony/cat/SelectItemParams;
    ...
    invoke-direct {v0, v1, v11, v2}, Lcom/android/internal/telephony/cat/SelectItemParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/Menu;Z)V

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mCmdParams:Lcom/android/internal/telephony/cat/CommandParams;

    .line 925
    move-object/from16 v0, p0

    iget v0, v0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mIconLoadState:I
    ...
    .line 855
    .end local v13           #presentTypeSpecified:Z
    :cond_a
    :try_start_9
    iget-object v0, v11, Lcom/android/internal/telephony/cat/Menu;->items:Ljava/util/List;
    ...
    const-string v17, "nextActionIndicator is null."
    ...
    const-string v18, "retrieveItemId ResultException: "
    ...
    const-string v18, "retrieveIconId ResultException: "
    ...
    .line 892
    .restart local v12       #ne:Ljava/lang/NullPointerException;
    const-string v17, "titleIconId is null."
    ...
    const-string v18, "retrieveItemsIconId ResultException: "
    ...
    .line 907
    .restart local v12       #ne:Ljava/lang/NullPointerException;
    const-string v17, "itemsIconId is null."
    ...
    .line 916
    .restart local v13       #presentTypeSpecified:Z
    :cond_d
    sget-object v17, Lcom/android/internal/telephony/cat/PresentationType;->NAVIGATION_OPTIONS:Lcom/android/internal/telephony/cat/PresentationType;
    ...
    iget v0, v0, Lcom/android/internal/telephony/cat/IconId;->recordNumber:I
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mIconLoader:Lcom/android/internal/telephony/cat/IconLoader;
    ...
    invoke-virtual/range {v17 .. v19}, Lcom/android/internal/telephony/cat/IconLoader;->loadIcon(ILandroid/os/Message;)V
    ...
    .line 943
    iget-object v14, v8, Lcom/android/internal/telephony/cat/ItemsIconId;->recordNumbers:[I

    .line 945
    .local v14, recordNumbers:[I
    iget-object v0, v8, Lcom/android/internal/telephony/cat/ItemsIconId;->recordNumbers:[I
    ...
    invoke-virtual {v0, v14, v1}, Lcom/android/internal/telephony/cat/IconLoader;->loadIcons([ILandroid/os/Message;)V

    goto/16 :goto_10

    .line 955
    .end local v14           #recordNumbers:[I
    :cond_13
    const/16 v17, 0x0
