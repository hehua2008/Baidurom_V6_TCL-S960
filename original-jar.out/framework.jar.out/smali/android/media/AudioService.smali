...
.field private static final DEFAULT_VOLUME_FOR_HEADSET:I = 0x4
...
.field public static final SEPARATE_RING_NOTIFICATION:Z = true
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, v0, Landroid/media/AudioService;->mFixedDevice:I
    ...
    .line 667
    sget-object v2, Landroid/media/AudioService;->SOUND_EFFECT_FILES:[Ljava/lang/String;

    const/4 v3, 0x0

    const-string/jumbo v4, "ro.config.audible_selection"
...
.method static synthetic access$4700(Landroid/media/AudioService;)I
    ...
    .prologue
    .line 109
    iget v0, p0, Landroid/media/AudioService;->mFixedDevice:I
...
.method static synthetic access$9200(Landroid/media/AudioService;)Landroid/media/AudioManager;
    .locals 1
    .parameter "x0"
...
.method private onCheckFmActive()V
    ...
    const-string/jumbo v3, "onCheckFmActive start! "
...
.method private onConfigureSafeVolume(Z)V
    ...
    const-string/jumbo v0, "ro.mmitest"
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    iput v2, p0, Landroid/media/AudioService;->mFixedDevice:I

    .line 4234
    const/4 v2, 0x2

    invoke-direct {p0, v2, p1}, Landroid/media/AudioService;->setVolumeOnHeadsetPlugOut(II)V
    ...
    .line 4262
    iput p1, p0, Landroid/media/AudioService;->mFixedDevice:I

    .line 4263
    const/4 v0, 0x2

    invoke-direct {p0, v0, p1}, Landroid/media/AudioService;->setVolumeOnHeadsetPlugIn(II)V
...
.method private sendVolumeUpdate(IIII)V
    ...
    .line 1244
    const-string/jumbo v1, "persist.sys.extra_volume"
...
.method private setVolumeOnHeadsetPlugIn(II)V
    .locals 12
    .parameter "streamType"
    .parameter "device"
    ...
    invoke-virtual {v6, v11, v7}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(ZI)Ljava/lang/String;

    move-result-object v4

    .line 4184
    .local v4, speakerName:Ljava/lang/String;
    sget-object v7, Landroid/media/AudioManager;->DEFAULT_STREAM_VOLUME:[I

    aget v3, v7, p1

    .line 4185
    .local v3, speakerDefaultIndex:I
    iget-object v7, p0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    invoke-static {v7, v4, v3, v10}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v5

    .line 4188
    .local v5, speakerVolume:I
    iget-object v7, p0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    ...
    invoke-static {v7, v8, v5, v10}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    .line 4191
    invoke-virtual {v6, v11, p2}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(ZI)Ljava/lang/String;
    ...
    .line 4193
    .local v0, headsetDefaultIndex:I
    iget-object v7, p0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    invoke-static {v7, v1, v0, v10}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v2

    .line 4196
    .local v2, headsetVolume:I
    invoke-virtual {p0, p1, v2, v11}, Landroid/media/AudioService;->setStreamVolume(III)V

    goto :goto_0
.end method

.method private setVolumeOnHeadsetPlugOut(II)V
    .locals 8
    .parameter "streamType"
    .parameter "device"
    ...
    invoke-virtual {v2, v7, v3}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(ZI)Ljava/lang/String;

    move-result-object v0

    .line 4212
    .local v0, speakerName:Ljava/lang/String;
    ...
    .line 4215
    .local v1, speakerVolume:I
    if-eq v1, v6, :cond_0

    .line 4217
    invoke-virtual {p0, p1, v1, v7}, Landroid/media/AudioService;->setStreamVolume(III)V
...
.method private updateStreamVolumeAlias(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/media/AudioService$VolumeStreamState;->applyRingIndexes(Z)V
