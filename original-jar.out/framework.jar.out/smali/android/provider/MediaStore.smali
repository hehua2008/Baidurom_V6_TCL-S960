...
.method private static getVideoThumbnailId(Landroid/content/ContentResolver;Landroid/net/Uri;J)J
    ...
    .line 2702
    .local v15, tmpUri:Ljava/lang/String;
    ...
    .line 2726
    .end local v11           #thumb_Id:J
    .local v13, thumb_Id:J
    :goto_0
    return-wide v13

    .line 2711
    .end local v13           #thumb_Id:J
    .restart local v11       #thumb_Id:J
    :cond_1
    :try_start_1
    invoke-interface {v8}, Landroid/database/Cursor;->moveToFirst()Z
    ...
    invoke-static {v2, v4, v10}, Lcom/mediatek/xlog/Xlog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v4, "getVideoThumbnailId: Exception!"
