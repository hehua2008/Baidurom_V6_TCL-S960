...
.method getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    .prologue
    .line 1839
    new-instance v12, Landroid/app/ActivityThread$ResourcesKey;
    ...
    invoke-direct {v12, v0, v1, v2, v3}, Landroid/app/ActivityThread$ResourcesKey;-><init>(Ljava/lang/String;ILandroid/content/res/Configuration;F)V

    .line 1843
    .local v12, key:Landroid/app/ActivityThread$ResourcesKey;
    move-object/from16 v0, p0
    ...
    iget-object v0, v0, Landroid/app/ActivityThread;->mActiveResources:Ljava/util/HashMap;
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/content/res/AssetManager;->isUpToDate()Z
    ...
    .line 1869
    .local v17, tsv:[Ljava/lang/String;
    move-object/from16 v0, v17
    ...
    const-string v20, "/JRD_custres/app/"
    ...
    .line 1872
    .local v15, resPath:Ljava/lang/String;
    new-instance v16, Ljava/io/File;
    ...
    .line 1873
    .local v16, res_file:Ljava/io/File;
    ...
    .end local v16           #res_file:Ljava/io/File;
    .end local v17           #tsv:[Ljava/lang/String;
    :cond_2
    :goto_2
    ...
    invoke-virtual {v5, v15}, Landroid/content/res/AssetManager;->addAssetPath(Ljava/lang/String;)I
    ...
    .end local v14           #r:Landroid/content/res/Resources;
    .end local v15           #resPath:Ljava/lang/String;
    ...
    .line 1878
    .restart local v17       #tsv:[Ljava/lang/String;
    move-object/from16 v0, v17
    ...
    .line 1881
    .restart local v15       #resPath:Ljava/lang/String;
    new-instance v16, Ljava/io/File;
    ...
    .line 1882
    .restart local v16       #res_file:Ljava/io/File;
    invoke-virtual/range {v16 .. v16}, Ljava/io/File;->exists()Z
    ...
    invoke-virtual {v0, v1, v2}, Landroid/app/ActivityThread;->getDisplayMetricsLocked(ILandroid/content/res/CompatibilityInfo;)Landroid/util/DisplayMetrics;
    ...
    #getter for: Landroid/app/ActivityThread$ResourcesKey;->mOverrideConfiguration:Landroid/content/res/Configuration;
    invoke-static {v12}, Landroid/app/ActivityThread$ResourcesKey;->access$3000(Landroid/app/ActivityThread$ResourcesKey;)Landroid/content/res/Configuration;
    ...
    invoke-virtual {v0, v7, v6}, Landroid/app/ActivityThread;->applyNonDefaultDisplayMetricsToConfigurationLocked(Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v6, v0}, Landroid/content/res/Configuration;->updateFrom(Landroid/content/res/Configuration;)I
    ...
    invoke-direct {v14, v5, v7, v6, v0}, Landroid/content/res/Resources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 1922
    :try_start_2
    const-string v19, "com.jrd.permission.SWITCH_JRDTHEME"
    ...
    invoke-interface {v13, v0, v1}, Landroid/content/pm/IPackageManager;->checkJrdThemePermission(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v11

    .line 1923
    .local v11, jrdThemePermission:Z
    const-string v19, "ActivityThread"

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string v21, "ContextImpl: jrdThemePermission = "
    ...
    .line 1925
    invoke-virtual {v14, v11}, Landroid/content/res/Resources;->setJrdThemePermission(Z)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0

    .line 1932
    .end local v11           #jrdThemePermission:Z
    :cond_9
    :goto_5
    move-object/from16 v0, p0
    ...
    .line 1935
    .local v9, existing:Landroid/content/res/Resources;
    :goto_6
    if-eqz v9, :cond_d
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/content/res/AssetManager;->close()V
    ...
    .line 1945
    .end local v9           #existing:Landroid/content/res/Resources;
    .end local v18           #wr:Ljava/lang/ref/WeakReference;,"Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;"
    :catchall_1
    move-exception v19
    ...
    .line 1943
    .restart local v9       #existing:Landroid/content/res/Resources;
    :cond_d
    :try_start_4
    move-object/from16 v0, p0
