...
.field private static final JRD_BLUR_AMOUNT:I = 0x40000000

.field private static final JRD_BLUR_AUTO_CORRECTION_COEF:I = 0x8000000

.field private static final JRD_BLUR_DIM_COEF:I = 0x20000000

.field private static final JRD_BLUR_OVERLAY_COEF:I = 0x10000000
...
.method private getValue(I)F
    ...
    invoke-virtual {v1}, Landroid/view/View;->getBlurAmount()F
    ...
    invoke-virtual {v1}, Landroid/view/View;->getBlurDimCoef()F
    ...
    invoke-virtual {v1}, Landroid/view/View;->getBlurOverlayCoef()F
    ...
    invoke-virtual {v1}, Landroid/view/View;->getBlurAutoCorrectionCoef()F
...
.method public jrdBlurAmount(F)Landroid/view/ViewPropertyAnimator;
    .locals 3
    .parameter "blurAmount"

    .prologue
    .line 1115
    const-string v0, "ViewPropAnim"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "jrdBlurAmount("
...
.method public jrdBlurAutoCorrectionCoef(F)Landroid/view/ViewPropertyAnimator;
    .locals 3
    .parameter "coef"
    ...
    const-string v2, "jrdBlurAutoCorrectionCoef("
...
.method public jrdBlurDimCoef(F)Landroid/view/ViewPropertyAnimator;
    .locals 3
    .parameter "coef"
    ...
    const-string v2, "jrdBlurDimCoef("
...
.method public jrdBlurOverlayCoef(F)Landroid/view/ViewPropertyAnimator;
    .locals 3
    .parameter "coef"
    ...
    const-string v2, "jrdBlurOverlayCoef("
