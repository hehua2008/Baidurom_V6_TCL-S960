...
.field private static final BLUR_LOG_TAG:Ljava/lang/String; = "ViewBlur"
...
.method protected drawBlur(Landroid/graphics/Canvas;)V
    ...
    .prologue
    .line 6654
    iget-boolean v4, p0, Landroid/view/View;->mBlurEnabled:Z

    if-eqz v4, :cond_1

    .line 6655
    const-string v4, "ViewBlur"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "ViewGroup.drawBlur("
    ...
    const-string v6, ", hasAnythingToBlurInLayer: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Landroid/view/View;->mHint_hasAnythingToBlurInLayer:Z
    ...
    .line 6656
    iget-boolean v4, p0, Landroid/view/View;->mHint_hasAnythingToBlurInLayer:Z
    ...
    const-string v6, "Child view doesn\'t have HARDWARE type anymore "
    ...
    .end local v2           #i:I
    :cond_1
    invoke-super {p0, p1}, Landroid/view/View;->drawBlur(Landroid/graphics/Canvas;)V
